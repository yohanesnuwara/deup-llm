...
try:
    from deup.domains.llm import HFGenerationConfig, LLMDEUPRiskEstimator, LLMTokenFeatureExtractor
except Exception:  # pragma: no cover - optional LLM dependencies may be absent
    pass
else:
    __all__ += ["HFGenerationConfig", "LLMDEUPRiskEstimator", "LLMTokenFeatureExtractor"]
